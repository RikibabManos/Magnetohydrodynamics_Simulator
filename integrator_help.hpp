...
inline void get_intermediary_grid(Grid& grid_functions, std::vector<double>& grid_property, const std::vector<double>& property_change, double scalar){ // helper function to compute the new grid vector states 
